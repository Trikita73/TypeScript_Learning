...
// Object Type
const create = (0: object | null): void => { };

create(1);        // Argument of type '1' is not assignable to paramenter of type 'object | null'
...
id = "42";      // No error, because type of "42" is string
